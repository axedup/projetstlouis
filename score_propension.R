...
greffematchit<-greffe[!greffe$intensite_condi=="NMA" & !is.na(greffe$age_greffe)
...
greffematchit$intensite_condi2<-ifelse(greffematchit$intensite_condi2=="RIC",1,0)
...
c(1,exp(greffematchitp$coef))
c(NA,paste("[",round(exp(greffematchitp$coef-1.96*sqrt(greffematchitp$var)),2),"-", 
