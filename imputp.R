...
"delai_pfs_60",                                                        
 ...
 "delai_dc_60",
"evenefs_60"  ,                                                         
"delai_rechutepg_60","pfs_60","date_gvhd_dc"  
)] <-rep("",24)
...
essai <- mice(greffe[,c("REMARQUE", "num_id", "j0", "first_name", "family_name", "ddn", 
                        ...
                        "anapath", "stade_dia", "age_greffe", "previous_auto", "previous_allo", 
                        "date_greffe_prece", "delai_allo_greffe_prece", "programme_autoallo", 
                        "rechute_prem_greffe", "condit_details", "tbi", "tbi_dose", "intensite_condi", 
                        "manipu_cells", "depletion", "immunosupression.détails", "nbr_donneur", 
                        "stem_cell_.source", "hla_match", "ddn_donor", "age_donor", "sex_donor", 
                        "sex_patient", "sex_dp", "cmv_dp", "Total.infused.nucleated.cells..donneur.1..", 
                        "Number.of.infused.CD34.positive.cells...donneur.1..", "Number.of.infused.CD3.positive.cells..T.cells....donneur.1..x.10E6.kg", 
                        "Total.infused.nucleated.cells...donneur.2..", "Number.of.infused.CD34.positive.cells...donneur.2.", 
                        "Number.of.infused.CD3.positive.cells..T.cells..donneur.2.x.10E6.kg", 
                        "relapsed_in_past", "disease_status_at_transplant", "karnofsky_greffe", 
                        "best_response_after_allo.", "date_rechute.", "X.relapse_progression_after_allo", 
                        "j0.", "nbr_lignes_avt_allo", "remarque.concernat.les.chimio.avant.allo", 
                        "programme_auto_allo", "previous_auto.1", "X1ERE.LIGNE.ttt..détails.", 
                        "X2.e.ligne..détails.", "X3.e.ligne..détails.", "X4.e.ligne..détails.", 
                        "X5.e.ligne..détails.", "prise_greffe", "Neutrophils....0.5.x.10.9.L.reached..i..ANC.recovery...i...", 
                        "Date.neutrophils....0.5.engraftment.date", "Date.platelets.....b.50..b..as.yyyy.mm.dd", 
                        "Interval.to.neutrophil.recovery..i..engraftment...i...days..", 
                        "chimérisme", "Date.of.chimaerism..as.yyyy.mm.dd", "J.de.l.évaluation.du.chimérisme", 
                        "agvhd_grade.", "agvhd_date.", "delai_agvhd_allo", "aGvHD.stage.in.skin.", 
                        "aGvHD.stage.in.liver.", "aGvHD.stage.in.gut.", "aGvHD.resolution.", 
                        "Date.of.resolution.of.aGvHD.", "cgvhd_date.", "delai_cgvhd_allo", 
                        "cgvhd.", "cgvhd_grade", "delai_allo_fu", "date_fu.", "Secondary.malignancy...clonal.complication.", 
                        "relapse_progression_transplant_2.", "Additional..treatment..includes.cell.therapy..", 
                        "ttt.a.la.rechute...en.détail.", "status_FU.", "survival_status_FU.", 
                        "cause_deces", "cause_death.", "date_rechutep", "date_fu", "agvhd_date", 
                        "cgvhd_date", "agvhd", "agvhd_grade", "agvhd3", "cgvhd", "cgvhd_gradec", 
                        "gvhd", "date_gvhd", "age_greffec", "prise_greffe1", "survival_status_FU", 
                        "deces", "anapath2", "anapathc", "anapathc2", "disease_status_at_transplantc", 
                        "disease_status_at_transplantc2", "stem_cell_source", "best_response_after_allo", 
                        "hla_matchc", "hla_matchc2", "donnor", "cause_death", "cause_death_c", 
                        "cause_death_c2", "delai_dia_alloc", "nbr_lignes_avt_alloc", 
                        "nbr_lignes_avt_alloc2", "programme_autoalloc", "previous_autoc", 
                        "rechute_prem_greffec", "rechute_post_allo", "nbr_donneurc", 
                        "karnofsky_greffec", "karnofsky_greffec2", "karnofsky_greffec3", 
                        "karnofsky_greffec4", "stade_diac", "sex_dp2", "sex_dp3", "cmv_dp2", 
                        "rechute", "rechute_progression", "relapse_progression_transplant_c", 
                        "rechute_progressionc", "rechute_progression_dc", "rechute_dc", 
                        "g_p", "rechute_progression_ghvd_dc", "efs_statut", "grfs", "agvhd_grave", 
                        "gvhd_dc", "delai_dc","delai_gvhd", "date_rechute", "date_rechute_progression", 
                        "date_rechute_progression_gvhd","date_gvhd_dc", "delai_pfs", 
                        "delai_rechute", "delai_rechutepg", "deces_60", "delai_dc_60")], m=1, maxit=1, pred=pred[c("REMARQUE", "num_id", "j0", "first_name", "family_name", "ddn", 
                                                                           "sex_patient.", "centre", "date_dia_l", "delai_dia_allo", "age_dia", 
                                                                           "anapath", "stade_dia", "age_greffe", "previous_auto", "previous_allo", 
                                                                           "date_greffe_prece", "delai_allo_greffe_prece", "programme_autoallo", 
                                                                           "rechute_prem_greffe", "condit_details", "tbi", "tbi_dose", "intensite_condi", 
                                                                           ...
                                                                           "gvhd_dc", "delai_dc","delai_gvhd", "date_rechute", "date_rechute_progression", 
                                                                           "date_rechute_progression_gvhd","date_gvhd_dc", "delai_pfs", 
                                                                           "delai_rechute", "delai_rechutepg", "deces_60", "delai_dc_60")
                                                                           ,c("REMARQUE", "num_id", "j0", "first_name", "family_name", "ddn", 
                                                                          "sex_patient.", "centre", "date_dia_l", "delai_dia_allo", "age_dia", 
                                                                          "anapath", "stade_dia", "age_greffe", "previous_auto", "previous_allo", 
                                                                          "date_greffe_prece", "delai_allo_greffe_prece", "programme_autoallo", 
                                                                          "rechute_prem_greffe", "condit_details", "tbi", "tbi_dose", "intensite_condi", 
                                                                          ...
                                                                          "gvhd_dc", "delai_dc","delai_gvhd", "date_rechute", "date_rechute_progression", 
                                                                          "date_rechute_progression_gvhd","date_gvhd_dc", "delai_pfs", 
                                                                          "delai_rechute", "delai_rechutepg", "deces_60", "delai_dc_60")],meth=
              meth[c("REMARQUE", "num_id", "j0", "first_name", "family_name", "ddn", 
                                                                                                        "sex_patient.", "centre", "date_dia_l", "delai_dia_allo", "age_dia", 
                                                                                                        "anapath", "stade_dia", "age_greffe", "previous_auto", "previous_allo", 
                                                                                                        "date_greffe_prece", "delai_allo_greffe_prece", "programme_autoallo", 
                                                                                                        "rechute_prem_greffe", "condit_details", "tbi", "tbi_dose", "intensite_condi", 
