...
source("C:/Users/adupont/Documents/projetstlouis/scripts/survie_dep_temps.R")
source("C:/Users/adupont/Documents/projetstlouis/scripts/survie_dep_temps_pfs.R")
source("C:/Users/adupont/Documents/projetstlouis/scripts/survie_tableau.R")
...
GRFS at 1 year was \Sexpr{round(reefs$surv[which.min((reefs$time-12)<0)],2)} (95 \% \Sexpr{round(reefs$lower[which.min((reefs$time-12)<0)-1],2)} - \Sexpr{round(reefs$upper[which.min((reefs$time-12)<0)-1],2)}), was \Sexpr{round(reefs$surv[which.min((reefs$time-24)<0)-1],2)} (95 \% \Sexpr{round(reefs$lower[which.min((reefs$time-24)<0)-1],2)} - \Sexpr{round(reefs$upper[which.min((reefs$time-24)<0)-1],2)}) at 2 years. GRFS at 4 years was \Sexpr{round(reefs$surv[which.min((reefs$time-48)<0)-1],2)} (95 \% \Sexpr{round(reefs$lower[which.min((reefs$time-48)<0)-1],2)} - \Sexpr{round(reefs$upper[which.min((reefs$time-48)<0)-1],2)}).
...
TRM at 1 year was \Sexpr{round(retrm$surv[which.min((retrm$time-12)<0)],2)} (95 \% \Sexpr{round(retrm$lower[which.min((retrm$time-12)<0)-1],2)} - \Sexpr{round(retrm$upper[which.min((retrm$time-12)<0)-1],2)}), was \Sexpr{round(retrm$surv[which.min((retrm$time-24)<0)-1],2)} (95 \% \Sexpr{round(retrm$lower[which.min((retrm$time-24)<0)-1],2)} - \Sexpr{round(retrm$upper[which.min((retrm$time-24)<0)-1],2)}) at 2 years. TRM at 4 years was \Sexpr{round(retrm$surv[which.min((retrm$time-48)<0)-1],2)} (95 \% \Sexpr{round(retrm$lower[which.min((retrm$time-48)<0)-1],2)} - \Sexpr{round(retrm$upper[which.min((retrm$time-48)<0)-1],2)}).
...
print(xtable (cspaic,
caption= "Multivariate analysis of 5 years cause specific mortality : HSCT related",
label="tab:uos",
table.placement="htp",caption.placement="top"),
tabular.environment="longtable",
floating=F,
