...
\pagebreak
EFS at 1 year was \Sexpr{round(reefs$surv[which.min((reefs$time-12)<0)],2)} (95 \% \Sexpr{round(reefs$lower[which.min((reefs$time-12)<0)-1],2)} - \Sexpr{round(reefs$upper[which.min((reefs$time-12)<0)-1],2)}), was \Sexpr{round(reefs$surv[which.min((reefs$time-24)<0)-1],2)} (95 \% \Sexpr{round(reefs$lower[which.min((reefs$time-24)<0)-1],2)} - \Sexpr{round(reefs$upper[which.min((reefs$time-24)<0)-1],2)}) at 2 years. EFS at 4 years was \Sexpr{round(reefs$surv[which.min((reefs$time-48)<0)-1],2)} (95 \% \Sexpr{round(reefs$lower[which.min((reefs$time-48)<0)-1],2)} - \Sexpr{round(reefs$upper[which.min((reefs$time-48)<0)-1],2)}).
...
\pagebreak
Relapse at 1 year was \Sexpr{round(rer$surv[which.min((rer$time-12)<0)-1],2)} (95 \% \Sexpr{round(rer$lower[which.min((rer$time-12)<0)-1],2)} - \Sexpr{round(rer$upper[which.min((rer$time-12)<0)-1],2)}), was \Sexpr{round(rer$surv[which.min((rer$time-24)<0)-1],2)} (95 \% \Sexpr{round(rer$lower[which.min((rer$time-24)<0)-1],2)} - \Sexpr{round(rer$upper[which.min((rer$time-24)<0)-1],2)}) at 2 years. Relapse at 4 years was \Sexpr{round(rer$surv[which.min((rer$time-48)<0)-1],2)} (95 \% \Sexpr{round(rer$lower[which.min((rer$time-48)<0)-1],2)} - \Sexpr{round(rer$upper[which.min((rer$time-48)<0)-1],2)}).
\\
\begin{center}
